...
// ReqParams are parameters needed to build and send an HTTP request to the service.
...
func HTTPSend(p *ReqParams) error {
	if p == nil {
		return eris.New("nil params")
	}
	// Get the endpoint/method via routeAttr struct
